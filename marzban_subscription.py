...
def user_subscription(
    ...
    response_headers = {
        ...
        "announce": encode_title("#ad0901Телеграм #ad0901канал: #00bfab@almetsam_bot"),
        "announce-url": "https://t.me/almetsam_bot",
...
def user_subscription_with_client_type(
    ...
    response_headers = {
        ...
        "support-url": SUB_SUPPORT_URL,
        "profile-title": encode_title(SUB_PROFILE_TITLE),
        "announce": encode_title("#ad0901Мой #ad0901телеграм #ad0901канал: #00bfab@almetsam_bot"),
        "announce-url": "https://t.me/almetsam_bot",
        "profile-update-interval": SUB_UPDATE_INTERVAL,
        "subscription-userinfo": "; ".join(
            f"{key}={val}"
